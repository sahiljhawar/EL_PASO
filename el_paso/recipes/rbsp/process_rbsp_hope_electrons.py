...
def rbsp_hope_electron_netcdf_strategy(
    ...
    *,
    ...
    """Monthly NetCDF saving strategy for RBSP HOPE electrons."""
...
def process_rbsp_hope_electrons(
    ...
    *,
    ...
    lower threshold to the flux, time-bins all variables to a common cadence, folds the pitch
...
if __name__ == "__main__":
    ep.run_recipe_cli(process_rbsp_hope_electrons)
