...
def compute_PSD(flux_var:ep.Variable, energy_var:ep.Variable, particle_species:Literal["electron", "proton"]) -> ep.Variable:
    ...
    return ep.Variable(data=psd_data, original_unit=(u.m * u.kg * u.m / u.s)**(-3))
