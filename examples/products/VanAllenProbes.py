...
class HOPE_electron(Product):
    ...
    def __init__(self, satellite_str, save_data_dir, download_data_dir, irbem_lib_path):
        ...
        varnames['Flux'] = 'FEDU'
        varnames['PA_local'] = 'PA_local_FEDU'
        varnames['xGEO'] = 'xGEO'
        ...
        self.default_save_standard = DataorgPMF(mission='RBSP', source=satellite_str, instrument='HOPE-electron-l3', save_text_segments=[save_data_dir, satellite_str,
        ...
        time_var = TimeVariable(name_or_column_in_file='Epoch_Ele', original_unit=u.epoch_tt2000, standard_name='Epoch_posixtime')

        variables_to_extract =  {
            'Epoch': time_var, 
            'Energy_FEDU': Variable(name_or_column_in_file='HOPE_ENERGY_Ele', standard_name='Energy_FEDU', original_unit=u.eV, target_unit=u.MeV, time_bin_method=TimeBinMethod.NanMedian, time_variable=time_var),
            ...
            'PA_local_FEDU': Variable(name_or_column_in_file='PITCH_ANGLE', original_unit='', target_unit='', standard_name='PA_local', time_bin_method=TimeBinMethod.NoBinning, time_variable=None),
