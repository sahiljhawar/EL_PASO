...
def save(
    ...
    *,
    ...
    if not ignore_validation:
        _validate_variables_dict(variables_dict, saving_strategy.data_standard)
...
def _validate_variables_dict(variables_dict: dict[InternalName, Variable], data_standard: DataStandard) -> None:
