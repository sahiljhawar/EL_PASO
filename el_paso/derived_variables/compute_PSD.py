...
from el_paso.standardization import validate_standard, get_standard_variable_by_type
...
def compute_PSD(input_variables, psd_variable, flux_key:str=None, energy_key:str=None):
    ...
    energy_var = input_variables[energy_key] if energy_key else get_standard_variable_by_type('Energy', input_variables)
